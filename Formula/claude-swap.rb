class ClaudeSwap < Formula
  # Compatibility alias for existing installs — identical build to
  # `claude-swap-cs` (the fork's canonical name). New installs should use claude-swap-cs.
  ...
  url "https://github.com/christopherstaton/claude-swap/archive/refs/tags/v0.27.0b1-fork14.tar.gz"
  version "0.27.0b1-fork14"
  sha256 "53c6d66e2954506ef58fe2c35ccfe4060ede1d47a74de9ac1f263b7479e04dda"
  license "MIT"
  ...
  test do
    assert_match "0.27.0b1", shell_output("#{bin}/cswap --version")
  end
end
